 ...
 */const k=typeof window!="undefined"&&window.customElements!=null&&window.customElements.polyfillWrapFlushCallback!==void 0,$=(e,t,n=null,i=null)=>{for(;t!==n;){const s=t.nextSibling;e.insertBefore(t,i),t=s}},O=(e,t,n=null)=>{for(;t!==n;){const i=t.nextSibling;e.removeChild(t),t=i}};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const j=new WeakMap,q=e=>(...t)=>{const n=e(...t);return j.set(n,!0),n},T=e=>typeof e=="function"&&j.has(e);/**
 * @license
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const H=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:e=>e}),z=` ${p} `;class A{constructor(e,t,n,i){this.strings=e,this.values=t,this.type=n,this.processor=i}getHTML(){const e=this.strings.length-1;let t="",n=!1;for(let i=0;i<e;i++){const s=this.strings[i],l=s.lastIndexOf("<!--");n=(l>-1||n)&&s.indexOf("-->",l+1)===-1;const a=_.exec(s);a===null?t+=s+(n?z:M):t+=s.substr(0,a.index)+a[1]+a[2]+v+a[3]+p}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");let t=this.getHTML();return H!==void 0&&(t=H.createHTML(t)),e.innerHTML=t,e}}class X extends A{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const e=super.getTemplateElement(),t=e.content,n=t.firstChild;return t.removeChild(n),$(t,n.firstChild),e}}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */class Z{handleAttributeExpressions(e,t,n,i){const s=t[0];if(s==="."){const a=new J(e,t.slice(1),n);return a.parts}if(s==="@")return[new Q(e,t.slice(1),i.eventContext)];if(s==="?")return[new K(e,t.slice(1),n)];const l=new B(e,t,n);return l.parts}handleTextExpression(e){return new I(e)}}const F=new Z;/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */typeof window!="undefined"&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const ee=(e,...t)=>new A(e,t,"html",F),te=(e,...t)=>new X(e,t,"svg",F);export{C as A,I as N,U as P,G as T,E as a,q as d,ee as h,V as i,p as m,N as n,O as r,te as s};
