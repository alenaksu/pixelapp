if(typeof document!="undefined"){const a=`/*
...
:root {
    ...
    --spectrum-alias-background-color-over-background-down: hsla(
        0,
        0%,
        100%,
        0.2
    ...
    --spectrum-alias-text-color-over-background-disabled: hsla(
        0,
        0%,
        100%,
        0.2
    ...
    --spectrum-alias-icon-color-over-background-disabled: hsla(
        0,
        0%,
        100%,
        0.2
...
/* stylelint-enable */
`,e=document.createElement("style"),n=document.createTextNode(a);e.type="text/css",e.appendChild(n),document.head.appendChild(e)}
