import o from"../Filter.js";export default class l extends o{constructor(...e){super(...e);this.name="Posterize",this.parameters={levels:10}}static get fragmentShader(){return`
